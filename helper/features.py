...
def aggregate_activity_by_hour(trans_df : pd.DataFrame, window_len)-> pd.DataFrame:
    ...
    # Moving averages of transaction volume.
    ...
    # Moving standard deviations of transaction volume.
    ...
    # Moving averages of transaction frequency.
    ...
    # Moving averages of location difference between consecutive transactions.
